        ...
        <div className='mt-[100px]'>
            ...
            <div className="overlay">
                <div className='max-w-[1440px] mx-auto'>
                    ...
                    <div className="counter flex justify-between items-center mb-28">
                       <div className='countDownOne flex gap-2 justify-between items-center'>
                       <div className=''>
                    ...
                    <div className='countDownOne flex gap-2 justify-center items-center'>
                       <div className=''>
                ...
                <div className="details flex justify-center items-center gap-5">
                    <div className="detailsLeft">
                        ...
                        <button className=' mt-3 text-[#ffffff] font-medium text-xl rounded-3xl bg-[#F14D5D] py-[15px] lg:px-[40px] px-[20px] transition duration-150 ease-linear hover:bg-[#fff] hover:text-[#F14D5D]'><Link className=''  to='#'>Book Now</Link></button>
                    </div>
                    <div className="detailsRight w-2/3">
                    <picture>
