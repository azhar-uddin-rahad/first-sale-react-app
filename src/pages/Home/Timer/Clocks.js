...
import timeImg from '../../../assits/Time.png'
    ...
    return (
        <Fragment>
            <section id='offerTime' className='bg-[#0A1831] mt-[100px] pb-[100px] '>
              ...
              <div className='lg:w-1/2 w-full lg:mr-14'>
                ...
                <div className="lg:w-1/2 w-full text-center lg:text-start pt-20 pb-20">
                  ...
                  <h4 className='text-4xl font-semibold mb-3 font-secondary text-[#ffffff]'>60% Discount</h4>
                  <h2 className='text-5xl font-bold mb-8 font-secondary text-[#ffffff]'>Sportswear Products</h2>
                <div className='timeZoon flex justify-center lg:justify-start'>
                    <div className="day mr-10 text-center text-[#ffffff]">
