...
const OurCompany = () => {
    ...
    return (
        <ScrollTrigger onEnter={()=>setCounterOn(true)} onExit={()=>setCounterOn(false)}>
            ...
            <div className="ourCompanyWraper flex gap-[5%] items-center">
                <div className='ourCompanyLeft w-[30]'>
                    <picture>
                        <img src="https://the7.io/wpbakery-starter/wp-content/uploads/sites/61/2020/01/bm015-1000x1000.jpg" alt="" />
                    </picture>

                </div>
                <div className='ourCompanyRright w-[60%]'>
                    ...
                    <div className='grid grid-cols-3 gap-5 mt-10'>
                        <div className='flex flex-col gap-3 justify-center items-center'>
                           <span className='text-5xl text-[#8D99FF]'> <FaCalendarCheck ></FaCalendarCheck></span>
                            ...
                            <p className='text-[16px] font-medium leading-[20px] text-[#000000]'>Returning customers</p>
                        </div>
                        <div className='flex flex-col gap-3 justify-center items-center'>
