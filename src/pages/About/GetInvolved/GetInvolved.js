...
import { FaCommentAlt, FaFacebookF, FaGoogle, FaInstagram, FaLinkedinIn, FaPlaneDeparture, FaRegCheckCircle, FaTwitter } from 'react-icons/fa';
    ...
    return (
        <div className='my-[100px]'>
            <div className='max-w-[1440px] mx-auto'>
                <h1 className='text-4xl text-[#000000] mb-20 font-bold p-5'>GetInvolved</h1>
                <div className='grid grid-cols-2 gap-5 justify-items-center content-center lg:grid-cols-4 text-center p-5'>
                    <div>
                      <span className='flex justify-center items-center text-[#8D99FF] text-5xl mb-5'> <FaPlaneDeparture></FaPlaneDeparture></span>
                        ...
                        <div className=' mt-5 rounded-full lg:w-80 bg-[#F14D5D] py-[10px] lg:px-[30px] px-[15px] flex justify-between'> 
