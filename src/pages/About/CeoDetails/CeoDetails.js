...
const CeoDetails = () => {
    return (
        <div className='max-w-[1440px] mx-auto'>
            <h1 className='text-4xl text-[#000000] font-bold my-20'>About Our Company</h1>
            ...
            <div className="ml-20">
                <h3 className='text-3xl text-[#000000] pr-[800px] mb-10'>Quisque erat urna, congue et libero in eleifend euismod velit.</h3>
           ...
           <div className="flex gap-10 items-center">
                ...
                <div className="w-1/2">
                    ...
                    <h3 className='text-3xl text-[#000000] pr-40 mb-10'>Duis convallis luctus pretium. Pellentesque habitant morbi</h3>
            ...
            <div className='absolute -bottom-1 left-20 rounded-lg bg-[#FFF] p-5'>
